...
# --- Seleccion aleatoria inicial del objetivo ---
while True:
...
# --- Funcion de clic para calibrar color o elegir objetivo ---
...
# --- Callback MQTT para recibir estado del robot ---
