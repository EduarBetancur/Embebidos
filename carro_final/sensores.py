...
class SensoresLaser:
    def _init_(self):
        ...
        self.XSHUT_PINS = [15, 16]  # Pines XSHUT para el sensor frontal (15) y sensor izquierdo (13)
    ...
    def leer_distancias(self):
        ...
        distancia_frontal = self.sensors[0].read()
        distancia_izquierda = self.sensors[1].read() + 55
