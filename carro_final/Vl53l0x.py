...
class VL53L0X:
    def _init_(self, i2c, address=0x29):
        self.i2c = i2c
    ...
    def change_address(self, new_address):
        ...
        if new_address < 0x08 or new_address > 0x77:
            raise ValueError("La dirección I2C debe estar entre 0x08 y 0x77.")
    
    # Escribir la nueva dirección en el registro de dirección I2C
        self._register(0x8A, new_address)
        self.address = new_address  # Actualizar la dirección en la instancia
